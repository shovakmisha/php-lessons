			...
			<div class='content col-lg-10 col-md-9 col-sm-9 col-xs-12'>
				...
				<?php 
					if (isset($id)){
						...
						if ($result == 'true') {echo "<p class='message'>Ваш друг удален!</p>";}
						else {echo "<p class='message'>Ваш друг не удален!</p>";}
					}else{
						echo "<p class='message'>Вы запустили данный файл без параметра id и поэтому, удалить друга невозможно (скорее всего Вы не выбрали радиокнопку на предыдущем шаге).</p>";
					}	 
				?>
			</div>
		</div>
