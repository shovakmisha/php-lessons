...
<title>Страница удаления друга</title>
	...
	<div class='container'>
		...
		<div class='row'>
			...
			<div class='content col-lg-10 col-md-9 col-sm-9 col-xs-12'>
				...
				<form class='forma' action='drop_friend.php' method='post'>
					<p class='podskazka'>Выберите друга для удаления</p>
					<?php 
						$result = mysql_query("SELECT name,id FROM friends");      
						$myrow = mysql_fetch_array($result);
						do{
							printf ("<p><label> <input name='id' type='radio' value='%s'> %s</label></p>",$myrow["id"],$myrow["name"]);
