				...
				<div class="ik">
				 ...
				 <?php 
					if (isset($title) && isset($meta_d) && isset($meta_k) && isset($text)){
						...
						if ($result == 'true') {echo "<p class='message'>Ваша страница успешно обновлена!</p>";}
						else {echo "<pp class='message'>>Ваша страница не обновлена!</p>";}
					}else{
						echo "<pp class='message'>>Вы ввели не всю информацию, поэтому данные этой страницы в базе не могут быть обновлены.</p>";
					}
				 ?>
			</div>	
		</div>
