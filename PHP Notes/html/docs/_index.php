...
<br><br><br><br><span style=\"font-size: 12px; color: #333; font-family: Verdana, Arial;\"><a href=\"http://".$_SERVER['HTTP_HOST']."/openserver/\">Перейти к стартовой странице</a></span></div>
</center>
</body>
</html>";
?>
