...
// Иван Никитин: дополним конструктор еще одним необязательным методом:
//      xmlEncoding - указание на кодировку XML
function XMLRPCMessage(methodname, xmlEncoding){
...
XMLRPCMessage.prototype.xml = function(){
  ...
  // Иван Никитин: формируем пролог документа
  if (this.xmlEncoding)
	xml += "<?xml version=\"1.0\" encoding=\"" + this.xmlEncoding + "\"?>\n";
  else
	xml += "<?xml version=\"1.0\"?>\n";
