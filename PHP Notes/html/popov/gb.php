...
<B><a href='gb.php'>Нажмите здесь, если не хотите больше ждать</a></B></td></tr></table></td></tr></table></center></body></html>";
exit;
}
}
...
<TD align=center><a href='gb.php?event=new&page=$page'>Добавить сообщение</a></TD>
...
if ($page==$ip) {print "<B>$ip</B> &nbsp;";} else {print "<a href=\"gb.php?page=$ip\">$ip</a> &nbsp;";}
$i=$i+$qq;}
