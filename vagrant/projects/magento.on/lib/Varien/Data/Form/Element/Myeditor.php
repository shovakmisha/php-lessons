 ...
 * Form editor element
 *
 * Цей клас по суті this цієї ноди з system.xml
 * <raw_text module="siteblocks">
 *   <label>Raw text</label>
 *   <frontend_type>myeditor</frontend_type>
...
class Varien_Data_Form_Element_Myeditor extends Varien_Data_Form_Element_Editor
{
    public function __construct($attributes=array())
    {
        ...
        if (Mage::getSingleton('cms/wysiwyg_config')->isEnabled()) {
            ...
            /**
             * Я подивив по методах внизу, то я бачив що вони використовують ці дані для будування візівіка. Це конфіги для нього
             *
             * я робив це саме для рендерінга картинки у едіт формі гріда, але іншим способом
             * 'config'    => Mage::getSingleton('cms/wysiwyg_config')->getConfig()
             * IGN_Siteblocks_Block_Adminhtml_Siteblocks_Edit_Form
             *
             * Тобто якщо брати по аналогії з візівікок у гріді, то це було б <config>cms/wysiwyg_config</config>
             * але розробники мадженти не реалізували цей функціонал
             */
    ...
    /**
     * ---- Цей і нижче написані методи не треба. і без них буде працювати
     *
     * Вони скопійовані з класу Varien_Data_Form_Element_Editor а я від нього екстенджусь
     *
     */
